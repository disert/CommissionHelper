...
import com.meishai.commission.helper.network.ApiInterface
import com.meishai.commission.helper.network.LogInterceptor
 ...
 */
class GlobalContext : MobApplication() {
    ...
    private val crashLogDir: String
        get() {
            ...
            mCacheRoot = dirF?.toString() ?: filesDir.toString()
